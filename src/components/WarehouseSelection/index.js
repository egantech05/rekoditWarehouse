...
const items = (lastBarColor = "#333333") => [
    ...
    { key: "w2", label: "Warehouse 2", icon: { name: "document-text-outline", color: "white" } },
    { key: "w3", label: "Warehouse 3", icon: { name: "people-outline", color: "white" } },
    { key: "w4", label: "Warehouse 2", icon: { name: "document-text-outline", color: "white" } },
    { key: "w5", label: "Warehouse 3", icon: { name: "people-outline", color: "white" } },
